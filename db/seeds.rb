...
Country.create( name: 'Korea, Democratic Peoples Republic of')
Country.create( name: 'Kosovo')
Country.create( name: 'Kyrgyzstan')
Country.create( name: 'Lao Peoples Democratic Republic')
...
5000000.times do
  User.create([{
    ...
    country_id: Faker::Number.between(1, 244),
    is_blockd: Faker::Boolean.boolean,
  }])
end
